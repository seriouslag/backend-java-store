...
public class Card {
    ...
    private String name;
    private String tokenenizationMethod;
    ...
    public String getTokenenizationMethod() {
        return tokenenizationMethod;
    }

    public void setTokenenizationMethod(String tokenenizationMethod) {
        this.tokenenizationMethod = tokenenizationMethod;
    }
